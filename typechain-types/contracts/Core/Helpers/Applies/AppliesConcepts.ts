...
export interface AppliesConceptsInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "applyConcept",
    values: [BytesLike, BigNumberish, BigNumberish]
  ): string;
  encodeFunctionData(functionFragment: "concepts", values: [BytesLike]): string;
  ...
  decodeFunctionResult(functionFragment: "addConcept", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "addWhitelist",
    data: BytesLike
  ): Result;
  ...
  decodeFunctionResult(functionFragment: "concepts", data: BytesLike): Result;
...
export namespace ConceptAddedEvent {
...
export namespace ConceptAppliedEvent {
  export type InputTuple = [
    conceptId: BytesLike,
...
export interface AppliesConcepts extends BaseContract {
  connect(runner?: ContractRunner | null): AppliesConcepts;
  waitForDeployment(): Promise<this>;

  interface: AppliesConceptsInterface;
  ...
  addConcept: TypedContractMethod<
    [
      conceptId: BytesLike,
      name: string,
      operationType: BigNumberish,
  ...
  applyConcept: TypedContractMethod<
    [
      conceptId: BytesLike,
      inputValue: BigNumberish,
  ...
  getEvent(
    ...
    ConceptAddedEvent.InputTuple,
    ConceptAddedEvent.OutputTuple,
    ConceptAddedEvent.OutputObject
  >;
  getEvent(
    key: "ConceptApplied"
  ): TypedContractEvent<
    ConceptAppliedEvent.InputTuple,
    ConceptAppliedEvent.OutputTuple,
    ConceptAppliedEvent.OutputObject
  >;
  getEvent(
    key: "Locked"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "ConceptAdded(bytes32,string,uint8,uint8,uint256)": TypedContractEvent<
      ConceptAddedEvent.InputTuple,
      ConceptAddedEvent.OutputTuple,
      ConceptAddedEvent.OutputObject
    >;
    ConceptAdded: TypedContractEvent<
      ConceptAddedEvent.InputTuple,
      ConceptAddedEvent.OutputTuple,
      ConceptAddedEvent.OutputObject
    >;

    "ConceptApplied(bytes32,uint256,uint256)": TypedContractEvent<
      ConceptAppliedEvent.InputTuple,
      ConceptAppliedEvent.OutputTuple,
      ConceptAppliedEvent.OutputObject
    >;
    ConceptApplied: TypedContractEvent<
      ConceptAppliedEvent.InputTuple,
      ConceptAppliedEvent.OutputTuple,
      ConceptAppliedEvent.OutputObject
    >;
