...
export interface BaseRegistryInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "baseRegisterableAddress",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "registryItems",
    values: [AddressLike]
  ): string;
  encodeFunctionData(
...
export namespace ItemStatusChangedEvent {
  export type InputTuple = [item: AddressLike, isActive: boolean];
  export type OutputTuple = [item: string, isActive: boolean];
  export interface OutputObject {
    item: string;
    isActive: boolean;
  }
...
export interface BaseRegistry extends BaseContract {
  ...
  baseRegisterableAddress: TypedContractMethod<[], [string], "view">;
  ...
  registerItem: TypedContractMethod<
    [item: AddressLike, description: string, data: BytesLike],
    [void],
    "nonpayable"
  >;

  registryItems: TypedContractMethod<
    [arg0: AddressLike],
    [
  ...
  setItemStatus: TypedContractMethod<
    [item: AddressLike, isActive: boolean],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "baseRegisterableAddress"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  filters: {
    ...
    "ItemRegistered(address,bool,string,bytes)": TypedContractEvent<
      ItemRegisteredEvent.InputTuple,
      ItemRegisteredEvent.OutputTuple,
      ItemRegisteredEvent.OutputObject
    >;
    ...
    "ItemStatusChanged(address,bool)": TypedContractEvent<
      ItemStatusChangedEvent.InputTuple,
      ItemStatusChangedEvent.OutputTuple,
      ItemStatusChangedEvent.OutputObject
    >;
