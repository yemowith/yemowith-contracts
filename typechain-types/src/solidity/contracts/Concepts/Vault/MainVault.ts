...
export interface MainVaultInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface MainVault extends BaseContract {
  connect(runner?: ContractRunner | null): MainVault;
  waitForDeployment(): Promise<this>;

  interface: MainVaultInterface;
