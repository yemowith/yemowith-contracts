...
export interface RegisterableInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
      | "OWNER_ROLE"
      | "REGISTRIES_MANAGER_ROLE"
      | "SUPER_ADMIN_ROLE"
      | "WHITELIST_ROLE"
      | "addWhitelist"
      | "getOwner"
  ...
  encodeFunctionData(
    functionFragment: "REGISTRIES_MANAGER_ROLE",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export namespace RegistryCreatedEvent {
  export type InputTuple = [
    registryType: BytesLike,
    registryAddress: AddressLike
  ];
  export type OutputTuple = [registryType: string, registryAddress: string];
  export interface OutputObject {
    registryType: string;
...
export interface Registerable extends BaseContract {
  connect(runner?: ContractRunner | null): Registerable;
  ...
  REGISTRIES_MANAGER_ROLE: TypedContractMethod<[], [string], "view">;
  ...
  registries: TypedContractMethod<[arg0: BytesLike], [string], "view">;
  ...
  getFunction(
    nameOrSignature: "REGISTRIES_MANAGER_ROLE"
  ): TypedContractMethod<[], [string], "view">;
  getFunction(
  ...
  filters: {
    ...
    "RegistryCreated(bytes32,address)": TypedContractEvent<
      RegistryCreatedEvent.InputTuple,
      RegistryCreatedEvent.OutputTuple,
      RegistryCreatedEvent.OutputObject
    >;
