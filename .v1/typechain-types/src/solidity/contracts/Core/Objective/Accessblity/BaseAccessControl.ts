...
export interface BaseAccessControlInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface BaseAccessControl extends BaseContract {
  connect(runner?: ContractRunner | null): BaseAccessControl;
  waitForDeployment(): Promise<this>;

  interface: BaseAccessControlInterface;
