...
export declare namespace CreationCodesManager {
  export type ContractTemplateStruct = {
    id: BigNumberish;
    name: string;
    description: string;
  ...
  export type ContractTemplateStructOutput = [
    id: bigint,
    name: string,
    description: string,
    creationCode: string
  ] & { id: bigint; name: string; description: string; creationCode: string };
}

export interface CreationCodesManagerInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "addContractTemplate",
  ...
  encodeFunctionData(
    functionFragment: "contractTemplates",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
    functionFragment: "getContractTemplate",
    values: [BigNumberish]
  ): string;
...
export namespace ContractTemplateAddedEvent {
...
export interface CreationCodesManager extends BaseContract {
  connect(runner?: ContractRunner | null): CreationCodesManager;
  waitForDeployment(): Promise<this>;

  interface: CreationCodesManagerInterface;
  ...
  addContractTemplate: TypedContractMethod<
    [name: string, description: string, creationCode: BytesLike],
    [void],
    "nonpayable"
  >;
  ...
  contractTemplates: TypedContractMethod<
    [arg0: BigNumberish],
    [
  ...
  getContractTemplate: TypedContractMethod<
    [templateId: BigNumberish],
    [CreationCodesManager.ContractTemplateStructOutput],
    "view"
  >;
  ...
  getFunction(
    nameOrSignature: "addContractTemplate"
  ): TypedContractMethod<
    [name: string, description: string, creationCode: BytesLike],
    [void],
    "nonpayable"
  ...
  getFunction(
    nameOrSignature: "contractTemplates"
  ): TypedContractMethod<
    [arg0: BigNumberish],
    [
      [bigint, string, string, string] & {
  ...
  >;
  getFunction(
    nameOrSignature: "getContractTemplate"
  ): TypedContractMethod<
    [templateId: BigNumberish],
    [CreationCodesManager.ContractTemplateStructOutput],
    "view"
  ...
  >;
  getEvent(
    key: "ContractTemplateAdded"
  ): TypedContractEvent<
    ContractTemplateAddedEvent.InputTuple,
    ContractTemplateAddedEvent.OutputTuple,
    ContractTemplateAddedEvent.OutputObject
  >;
  getEvent(
    key: "Locked"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "ContractTemplateAdded(uint256,string,string)": TypedContractEvent<
      ContractTemplateAddedEvent.InputTuple,
      ContractTemplateAddedEvent.OutputTuple,
      ContractTemplateAddedEvent.OutputObject
    >;
    ContractTemplateAdded: TypedContractEvent<
      ContractTemplateAddedEvent.InputTuple,
      ContractTemplateAddedEvent.OutputTuple,
      ContractTemplateAddedEvent.OutputObject
    >;
