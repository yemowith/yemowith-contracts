...
export interface WithExecutorContract
  extends Truffle.Contract<WithExecutorInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<WithExecutorInstance>;
}
...
export interface WithExecutorInstance extends Truffle.ContractInstance {
