...
export interface RegisterableContract
  extends Truffle.Contract<RegisterableInstance> {
  "new"(meta?: Truffle.TransactionDetails): Promise<RegisterableInstance>;
}
...
export interface RegisterableInstance extends Truffle.ContractInstance {
