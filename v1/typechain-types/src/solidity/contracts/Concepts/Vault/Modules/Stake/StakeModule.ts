...
export interface StakeModuleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface StakeModule extends BaseContract {
  connect(runner?: ContractRunner | null): StakeModule;
  waitForDeployment(): Promise<this>;

  interface: StakeModuleInterface;
