...
export interface WithExecutorInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "ADMIN_ROLE"
      | "DEFAULT_ADMIN_ROLE"
...
export interface WithExecutor extends BaseContract {
  connect(runner?: ContractRunner | null): WithExecutor;
  waitForDeployment(): Promise<this>;

  interface: WithExecutorInterface;
