...
export interface BaseEncoderInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "LOCKER_ROLE"
  ...
  encodeFunctionData(
    functionFragment: "verifyEncodedData",
...
export interface BaseEncoder extends BaseContract {
  connect(runner?: ContractRunner | null): BaseEncoder;
  ...
  verifyEncodedData: TypedContractMethod<
    [
  ...
  getFunction(
    nameOrSignature: "verifyEncodedData"
  ): TypedContractMethod<
    [
      encodedData: BytesLike,
      originalData: BytesLike,
