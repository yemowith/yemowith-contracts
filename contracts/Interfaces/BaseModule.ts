...
export interface BaseModuleInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "enabledModules",
    values: [AddressLike]
  ): string;
...
export interface BaseModule extends BaseContract {
  ...
  enabledModules: TypedContractMethod<[arg0: AddressLike], [boolean], "view">;
  ...
  getFunction(
    nameOrSignature: "enabledModules"
  ...
  filters: {
    ...
    "ModuleDisabled(address)": TypedContractEvent<
      ModuleDisabledEvent.InputTuple,
      ModuleDisabledEvent.OutputTuple,
      ModuleDisabledEvent.OutputObject
    >;
    ...
    "ModuleEnabled(address)": TypedContractEvent<
      ModuleEnabledEvent.InputTuple,
      ModuleEnabledEvent.OutputTuple,
      ModuleEnabledEvent.OutputObject
    >;
