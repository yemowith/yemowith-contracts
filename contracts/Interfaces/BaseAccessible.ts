...
export interface BaseAccessibleInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DEFAULT_ADMIN_ROLE"
      | "LOCKER_ROLE"
...
export interface BaseAccessible extends BaseContract {
  connect(runner?: ContractRunner | null): BaseAccessible;
  waitForDeployment(): Promise<this>;

  interface: BaseAccessibleInterface;
